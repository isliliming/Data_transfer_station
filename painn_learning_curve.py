...
data =spk.data.AtomsDataModule(
        os.path.join('/home/l/liming/painn_learning_curve01/THz_orig_dataset_energy.db'),
        batch_size=10,
        distance_unit='Ang',
        property_units={'energy':'kcal/mol'},
       #  num_train=1752, # comment if split file
       # num_val=438, # comment if split file
        split_file="/home/l/liming/painn_learning_curve01/split{}.npz".format(nsplit),
        transforms=[
...
db=ase.db.connect('/home/l/liming/painn_learning_curve01/THz_orig_dataset_energy.db')
for i in range(546):
    idx=data.test_idx[i]
  #  print("idx ",idx)
