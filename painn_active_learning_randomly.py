...
data =spk.data.AtomsDataModule(
       ...
       # num_val=438, # comment if split file
        split_file="/home/l/liming/painn_active_learning_randomly/split{}.npz".format(nsplit),
        transforms=[
...
db=ase.db.connect('/home/l/liming/painn_active_learning_randomly/THz_orig_plus_filtered_energy.db')
for i in range(86):
    idx=data.test_idx[i]
  #  print("idx ",idx)
